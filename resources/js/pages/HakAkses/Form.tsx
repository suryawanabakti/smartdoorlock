...
import { type HakAkses, type HakAksesFormData } from '@/types/hak-akses';
...
export default function HakAksesForm({
    hakAkses,
    ruangans,
    mahasiswas,
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-4 pt-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    checked={data.is_approve}
                                    onCheckedChange={(checked) =>
                                        setData('is_approve', checked)
                                    }
                                />
                            </div>
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    checked={data.is_by_admin}
                                    onCheckedChange={(checked) =>
                                        setData('is_by_admin', checked)
                                    }
                                />
                            </div>
                        </div>
